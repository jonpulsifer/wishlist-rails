...
class YARD::CLI::Server < ::YARD::CLI::Command
  ...
  def server_options=(_); end
  def template_paths; end
  def template_paths=(_); end
...
class YARD::CLI::Yardoc < ::YARD::CLI::YardoptsCommand
  ...
  def fail_on_warning=(_); end
  def files; end
  def files=(_); end
  def generate; end
  def generate=(_); end
  def has_markup; end
  def has_markup=(_); end
  def hidden_apis; end
  def hidden_apis=(_); end
  def hidden_tags; end
  def hidden_tags=(_); end
  def list; end
  def list=(_); end
  def options; end
  def parse_arguments(*args); end
  def run(*args); end
  def save_yardoc; end
  def save_yardoc=(_); end
  def statistics; end
  def statistics=(_); end
  def use_cache; end
  def use_cache=(_); end
...
class YARD::CLI::YardoptsCommand < ::YARD::CLI::Command
  ...
  def options_file=(_); end
  def parse_arguments(*args); end
  def use_document_file; end
  def use_document_file=(_); end
  def use_yardopts_file; end
  def use_yardopts_file=(_); end
...
class YARD::CodeObjects::MacroObject < ::YARD::CodeObjects::Base
  ...
  def macro_data; end
  def macro_data=(_); end
  def method_object; end
  def method_object=(_); end
  def path; end
  def sep; end
...
class YARD::Logger < ::Logger
  ...
  def show_backtraces=(_); end
  def show_progress; end
  def show_progress=(_); end
  def warn(*args); end
...
class YARD::Parser::Ruby::AstNode < ::Array
  ...
  def docstring_hash_flag=(_); end
  def docstring_range; end
  def docstring_range=(_); end
  def file; end
  def file=(_); end
  def first_line; end
  def full_source; end
  def full_source=(_); end
  def group; end
  def group=(_); end
  def has_line?; end
  def inspect; end
...
class YARD::Parser::Ruby::Legacy::RubyLex
  ...
  def exception_on_syntax_error=(_); end
  def get_read; end
  def getc; end
  ...
  def read_auto_clean_up=(_); end
  def read_escape; end
  def skip_inner_expression; end
  def skip_space; end
  def skip_space=(_); end
  def token; end
...
class YARD::Parser::Ruby::Legacy::StatementList < ::Array
  ...
  def encoding_line; end
  def encoding_line=(_); end
  def shebang_line; end
  def shebang_line=(_); end
...
class YARD::Server::LibraryVersion
  ...
  def source=(_); end
  def source_path; end
  def source_path=(_); end
  def to_s(url_format = T.unsafe(nil)); end
  def version; end
  def version=(_); end
  def yardoc_file; end
  def yardoc_file=(_); end
...
class YARD::Tags::Library
  ...
  class << self
    ...
    def transitive_tags=(_); end
    def visible_tags; end
    def visible_tags=(_); end
...
class YARD::Templates::TemplateOptions < ::YARD::Options
  ...
  def default_return=(_); end
  def embed_mixins; end
  def embed_mixins=(_); end
