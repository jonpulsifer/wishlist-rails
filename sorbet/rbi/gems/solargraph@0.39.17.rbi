...
Solargraph::CoreFills::KEYWORDS = T.let(T.unsafe(nil), Array)

Solargraph::CoreFills::OVERRIDES = T.let(T.unsafe(nil), Array)
...
class Solargraph::Pin::Attribute < ::Solargraph::Pin::BaseMethod
...
class Solargraph::Pin::BaseMethod < ::Solargraph::Pin::Closure
...
class Solargraph::Pin::Method < ::Solargraph::Pin::BaseMethod
  include(::Solargraph::Parser::Rubyvm::NodeMethods)
...
class Solargraph::Pin::MethodAlias < ::Solargraph::Pin::BaseMethod
...
class Solargraph::Pin::YardPin::Constant < ::Solargraph::Pin::Constant
  include(::Solargraph::Pin::YardPin::YardMixin)

  def initialize(code_object, closure = T.unsafe(nil), spec = T.unsafe(nil)); end
end

class Solargraph::Pin::YardPin::Method < ::Solargraph::Pin::Method
  include(::Solargraph::Pin::YardPin::YardMixin)
  ...
  def arg_name(a); end
  def arg_type(a); end
  def get_parameters(code_object); end
end

class Solargraph::Pin::YardPin::Namespace < ::Solargraph::Pin::Namespace
  include(::Solargraph::Pin::YardPin::YardMixin)
...
class Solargraph::Source
  ...
  def code=(val); end
  def comments=(_); end
  def error_ranges=(_); end
  def filename=(_); end
  def last_updater; end
  def last_updater=(_); end
  def node=(_); end
  def parsed=(_); end
  def repaired; end
  def repaired=(_); end
  ...
  def inner_folding_ranges(top, result = T.unsafe(nil)); end
...
Solargraph::StdlibFills::LIBS = T.let(T.unsafe(nil), Hash)
