...
class Faker::Books::Lovecraft < ::Faker::Base
  class << self
    ...
    def sentence(legacy_word_count = T.unsafe(nil), legacy_random_words_to_add = T.unsafe(nil), word_count: T.unsafe(nil), random_words_to_add: T.unsafe(nil)); end
...
class Faker::Company < ::Faker::Base
  class << self
    ...
    def spanish_organisation_number; end
    def suffix; end
